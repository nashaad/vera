...
/**
 * Extra parsers registered through OpenTUI's Tree-sitter integration. Its
 * JavaScript, TypeScript, Markdown, and Zig parsers remain built in; OpenTUI
 * fetches and caches these additional parsers only when a matching fence or
 * file is rendered.
 */
