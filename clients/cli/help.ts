...
export const CLI_COMMANDS: readonly CliCommandHelp[] = [
    ...
    { usage: "vera doctor", description: "Check resident hosts, Vera process health, leftover tmux sockets, and providers; stops leftover isolated hosts, workers, fixtures, forgotten clients, and stale Vera tmux sockets after asking" },
    { usage: "vera doctor --yes", description: "Stop stray processes and remove leftover Vera tmux sockets without asking first" },
