...
export const CLI_COMMANDS: readonly CliCommandHelp[] = [
    ...
    { usage: "vera doctor", description: "Check resident hosts, Vera process health, and providers; asks before stopping any stray process it finds" },
    { usage: "vera doctor --yes", description: "Stop stray processes without asking first" },
