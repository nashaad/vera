...
const TUI_PARTITION = {
    ...
    "notices.ts": ["showStatusNotice", "showModeToast", "hideModeToast", "modeToastTakesEscape", "enqueueModeToast", "dismissModeToast", "clipToastMessage", "layoutModeToast", "layoutModeToastBand", "showVerificationConsole", "verificationConsoleRows", "hideVerificationConsole", "dropSettledVerificationConsole", "liveVerificationConsole", "renderJumpToBottom", "renderSidebarJump", "renderPendingQuote", "renderHeldAddress", "paneHeaderText"],
