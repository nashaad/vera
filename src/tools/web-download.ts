...
export const webDownloadTool: RegisteredTool = {
    ...
    definition: {
        ...
        description: [
            ...
            "Downloads folder and report where it landed. Use this when the",
            "user wants the file itself; use web_fetch instead when the",
            "contents are what matters. The contents are not read or",
