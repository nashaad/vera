...
---`,
    ...
    },
    {
        ...
        writer: 'vera',
        placement: 'home',
        summary: 'Halcyon run journals, one directory per run.',
        loads: 'Read by `resume`, `show`, and the Runs page.',
        detail: 'A resumed run replays finished steps from its journal instead of running them again.',
        documentedIn: 'workflow-runs',
        children: [
            {
                name: '<run-id>/',
                path: '<run-id>/',
                ...
                writer: 'vera',
                placement: 'home',
                summary: 'One run: its header, journal, and spans.',
                loads: 'Read by `resume`, `show`, and the Runs page.',
                detail: 'Runs written to a SQLite journal or to a directory of your own do not appear on the Runs page.',
                documentedIn: 'python-workflows',
                children: [
                    {
                        name: 'header.json',
                        path: 'header.json',
                        ...
                        writer: 'vera',
                        placement: 'home',
                        summary: 'Run metadata, inputs, and one entry per attempt.',
                        loads: 'Read on resume and by the Runs page.',
                        detail: 'Names the step that is running under `active`. Each attempt records when it started, its process and host, and how it ended.',
                        documentedIn: 'python-workflows',
                    },
                    {
                        name: 'journal.ndjson',
                        ...
                        writer: 'vera',
                        placement: 'home',
                        summary: 'One record per successful step.',
                        loads: 'Read on resume.',
                        detail: 'Each record holds the step result, when it finished, and how long it took. Values over 8192 bytes go to `blobs/`.',
                        documentedIn: 'python-workflows',
                    },
                    {
                        name: 'spans.ndjson',
                        ...
                        writer: 'vera',
                        placement: 'home',
                        summary: 'Every try of every step, and every recorded model call.',
                        loads: 'Read by `show` and the Runs page.',
                        detail: 'Two lines per span, one opening it and one settling it. Field names follow OpenTelemetry.',
                        documentedIn: 'python-workflows',
                    },
                ],
            },
