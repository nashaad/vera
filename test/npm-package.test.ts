...
test("npm package contains only the curated runtime and release metadata", () => {
    ...
    try {
        ...
        expect(entries).toContain("package/src/core-extensions/web-search/extension.ts");
        expect(entries).toContain("package/src/core-extensions/web-search/search.ts");
        expect(entries).toContain("package/src/core-extensions/web-search/vera.extension.json");
